...
> This work proposes to finetune LLMs for better RAG, an exact effort to address bottleneck 2) commented above. The key idea is, during finetuning, both   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTY5MDY3MTU4LDExNTk5MTEwMTAsMTg5OD
