...
> The first step towards adaptivity is to automatically determine the complexity of a given query. The authors hence trained a  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI2NTQxODExMCw4MzM4OTIxMjUsLTkwND
