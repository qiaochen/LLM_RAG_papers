...
- Alignment:
	...
	- Normally, this step requires a trained reward model that can score LLM's outputs based on human preferences, during  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODEzNzQyMTA4LC05MzM4NzcxMTYsLTE5ND
