...
- Instruct [fine] tuning:
	- In a more general sense, is to con train LLM bases to conduct different tasks according to the task-specific meta information described in the instruction. There is also motivation to generalise such ability to unseen instructions (e.g., tasks) after tuning. Example projects include:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMwMDc3MDAyLDcyNzQ5ODA4MywtNTM3MD
