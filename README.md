...
> LLMs are not trained to exploit facts from provided passages. Authors train a LM to learn to reflect on its own generation processing given a input, by generating both task output and intermediate special tokens (reflection tokens: retrieval and critique). Retrieval indicate retrieving docu
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODIwNzIyMTA3LDEzNzk4NjE1MDgsMjg0OT
