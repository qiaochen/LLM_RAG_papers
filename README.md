...
- [Retrieval-augmented generation (RAG)](https://arxiv.org/abs/2005.11401):
	...
	-  Important components in RAG:
		...
		- Reranker
			- Different from retriever, modern rerankers usually take in both query and document as input to rerank the documents, thus more computationally expensive. Normally, they are applied to top-K candidate documents that are returned by a retriever.   
		- Indexed resources
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjAxMTE2NTg1LC0xNzM2MzA1MTgsMTI1Mz
