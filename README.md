...
> _This paper explores and evaluates the impact of RAG and FT (supervised) on customizing LLMs in handling low-frequency entities on question answering task._ Their base model is a T5 variation, FlanT5. Most solid conclusion from Table 2 is that RAG can greatly (10X on FlanT5-base)  boost the performance of LLM without any finetuning, while finetuning alone can achieve <2 times performance gain on FlanT5-base. RAG + finetuning only achieves slightly better per 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDQ4NTgzODcwLC0xMDQzOTE0NTE4LDE4OT
...
NDc2NywyMDI0MDk5NzA1LC00NTY1ODU1OTEsMTAyMjAwNzcyOC
wtNjQ4MzYyMjI1LC0xMDY1ODc0OTgzLC01NDcwMzkwODEsLTYx
ODkyOTk0MV19
-->