...
- [Retrieval-augmented generation (RAG)](https://arxiv.org/abs/2005.11401):
	...
	- In a vanila RAG system, LLM can be a fixed model, so the upper bound of the response quality is determined by the retrieval system and the external resources. 
		...
		- Traditional  retrieval system such as Lucene based [Solr](https://solr.apache.org/) and  [Elasticsearch](https://www.elastic.co/downloads/elasticsearch) can be a rescue in such scenarios.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzQxNTU0NTg2LC02NDgzNjIyMjUsLTEwNj
