...
- Fine tuning:
	...
	- A pretrained or fine tuned __base model__ can be good at text generation, but still it can not well conduct instruct following tasks, e.g., instruct it to summarize, answer questions or chat. To enable LLMsthe instruct following ability, there is a need for _instruct fine tuning_.    
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDU5Mjk1ODY3LDcyNzQ5ODA4MywtNTM3MD
