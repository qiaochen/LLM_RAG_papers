...
> Steps: 1) entity recognition from user prompt, 1) biomedical concept extraction from KG, 3) prompt-aware context generation, 4) conversion to language, 5) prompt assembly, and 6)   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA2MDA1NDI0MiwxMjM2MjgxNjcyLC05OT
