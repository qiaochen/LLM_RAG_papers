	...
	-  Important components in RAG:
		...
		- Retriever 
			...
			- Sparse embedding-based:
				- In contrast to dense embeddings, sparse embeddings normally work in the input token/subtoken level, where query and documents are represented in bags of tokens, b 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzMjE4Njg5NCwtMTczNjMwNTE4LDEyNT
