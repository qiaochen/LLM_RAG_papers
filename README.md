...
- Fine tuning:
	...
	- A pretrained or fine tuned __base model__ can be good at text generation, but still can not be used t  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc5NDg4NjM0NiwtMTYyNzQyODcsMTg3OD
