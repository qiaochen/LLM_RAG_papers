...
> This work fine-tunes LLMs to improve the quality of citation. A fine-tuning training prompt consists of query, response (multi-sentence) and citations (per-sentence, if any). They prompt LLM-base and 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg3MzYxMDE1MCwtMTg4Njc2MTM3Niw5NT
