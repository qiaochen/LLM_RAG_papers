...
> For finetuning LLM, given a (prompt, response) pair, after retrieving C documents, each of them is prepended to prompt, creating C triple datapoints of $\{[c_{i,j};x]  \}$. These constitute the augmented training samples and 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NDM5NzY1NjYsLTk3Njg1OTI3OCwtOT
